...
//	일하는 중입니다.
	...
	public static void main(String[] args) {
		SchoolMember[] schoolMember = new SchoolMember[3];
		schoolMember[0] = new Student();
		schoolMember[1] = new Student();
		schoolMember[2] = new Student();
